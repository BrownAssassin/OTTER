...
int main() {
	...
	VertexArrayObject::sptr vao = ObjLoader::LoadObj("monkey.obj");
	...
	transform2 = glm::translate(transform2,	glm::vec3(0.0f, 2.5f, 0.0f));
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) {
			...
			transform2 = glm::translate(transform2, glm::vec3(1.0f * dt, 0.0f, 0.0f));
		}
		...
		if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS) {
			...
			transform2 = glm::translate(transform2, glm::vec3(0.0f, -1.0f * dt, 0.0f));
		}
		...
		transform = glm::rotate(transform, glm::radians(rotSp), glm::vec3(0, 0, 1));
		transform2 = glm::rotate(transform2, glm::radians(rotSp), glm::vec3(0, 1, 0));
